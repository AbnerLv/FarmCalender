...
public class ScheduleInfoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editInfo = new BorderEditText(ScheduleInfoActivity.this, null);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			case Menu.FIRST:
				...
				intent.setClass(ScheduleInfoActivity.this, ScheduleAllActivity.class);
	...
	public void handlerInfo(int scheduleID){
		...
		type.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				new AlertDialog.Builder(ScheduleInfoActivity.this).setTitle("删除日程").setMessage("确认删除").setPositiveButton("确认", new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						intent1.setClass(ScheduleInfoActivity.this, ScheduleAllActivity.class);
