 ...
 *
 */
public class CalendarConvertActivity extends Activity {
	...
	public CalendarConvertActivity(){
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		convertDate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new DatePickerDialog(CalendarConvertActivity.this, new OnDateSetListener() {
					...
					public void onDateSet(DatePicker view, int year, int monthOfYear,
						...
						if(year < 1901 || year > 2049){
							//不在查询范围内
							new AlertDialog.Builder(CalendarConvertActivity.this).setTitle("错误日期").setMessage("跳转日期范围(1901/1/1-2049/12/31)").setPositiveButton("确认", null).show();
						}else{
							year_c = year;
